...
n = o.style.display, t ? (r[a] || "none" !== n || (o.style.display = ""), "" === o.style.display && k(o) && (r[a] = ut._data(o, "olddisplay", D(o.nodeName)))) :r[a] || (i = k(o), 
...
function D(e) {
var t = J, n = bn[e];
return n || (n = C(e, t), "none" !== n && n || (un = (un || ut("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(t.documentElement), 
t = (un[0].contentWindow || un[0].contentDocument).document, t.write("<!doctype html><html><body>"), 
t.close(), n = C(e, t), un.detach()), bn[e] = n), n;
}
function C(e, t) {
...
if (i) return !1;
for (var t = Zn || B(), n = Math.max(0, c.startTime + c.duration - t), o = n / c.duration || 0, r = 1 - o, a = 0, l = c.tweens.length; l > a; a++) c.tweens[a].run(r);
...
"inline" === ut.css(e, "display") && "none" === ut.css(e, "float") && (ut.support.inlineBlockNeedsLayout && "inline" !== D(e.nodeName) ? d.zoom = 1 :d.display = "inline-block")), 
...
for (o in u) a = P(p ? h[o] :0, o, c), o in h || (h[o] = a.start, p && (a.end = a.start, 
...
var U, V, G = typeof t, X = e.location, J = e.document, K = J.documentElement, Q = e.jQuery, Z = e.$, et = {}, tt = [], nt = "1.10.0", ot = tt.concat, it = tt.push, rt = tt.slice, at = tt.indexOf, st = et.toString, lt = et.hasOwnProperty, ct = nt.trim, ut = function(e, t) {
return new ut.fn.init(e, t, V);
}, dt = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, pt = /\S+/g, ht = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, mt = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, gt = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, ft = /^[\],:{}\s]*$/, _t = /(?:^|:|,)(?:\s*\[)+/g, yt = /\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g, vt = /"[^"\\\r\n]*"|true|false|null|-?(?:\d+\.|)\d+(?:[eE][+-]?\d+|)/g, wt = /^-ms-/, bt = /-([\da-z])/gi, xt = function(e, t) {
return t.toUpperCase();
}, kt = function(e) {
(J.addEventListener || "load" === e.type || "complete" === J.readyState) && (St(), 
ut.ready());
}, St = function() {
...
t && ft.test(t.replace(yt, "@").replace(vt, "]").replace(_t, ""))) ? new Function("return " + t)() :void ut.error("Invalid JSON: " + t);
},
parseXML:function(n) {
var o, i;
...
if (!U) if (U = ut.Deferred(), "complete" === J.readyState) setTimeout(ut.ready); else if (J.addEventListener) J.addEventListener("DOMContentLoaded", kt, !1), 
...
if ((t ? t.ownerDocument || t :z) !== O && q(t), t = t || O, n = n || [], !e || "string" != typeof e) return n;
...
} else if (t.ownerDocument && (r = t.ownerDocument.getElementById(a)) && R(t, r) && r.id === a) return n.push(r), 
n;
} else {
...
p = _t.test(e) && t.parentNode || t, h = c.join(",");
}
if (h) try {
...
function s(e, t, n) {
e = e.split("|");
for (var o, i = e.length, r = n ? null :t; i--; ) (o = C.attrHandle[e[i]]) && o !== t || (C.attrHandle[e[i]] = r);
}
function l(e, t) {
...
for (a in C.filter) !(i = bt[a].exec(s)) || c[a] && !(i = c[a](i)) || (o = i.shift(), 
r.push({
value:o,
type:a,
matches:i
...
function _(e, t, n) {
var o = t.dir, i = n && "parentNode" === o, r = U++;
...
} else if (l = c[o] = [ u ], l[1] = e(t, n, a) || D, l[1] === !0) return !0;
};
}
function y(e) {
...
var c, u, d, p = [], h = [], m = a.length, g = r || k(t || "*", s.nodeType ? [ s ] :s, []), f = !e || !r && t ? g :v(g, p, e, s, l), _ = n ? i || (r ? e :m || o) ? [] :a :f;
if (n && n(f, _, s, l), o) for (c = v(_, h), o(c, [], s, l), u = c.length; u--; ) (d = c[u]) && (_[h[u]] = !(f[h[u]] = d));
if (r) {
if (i || e) {
if (i) {
for (c = [], u = _.length; u--; ) (d = _[u]) && c.push(f[u] = d);
i(null, _ = [], c, l);
}
for (u = _.length; u--; ) (d = _[u]) && (c = i ? at.call(r, d) :p[u]) > -1 && (r[c] = !(a[c] = d));
}
} else _ = v(_ === a ? _.splice(m, _.length) :_), i ? i(null, a, _, l) :it.apply(a, _);
});
}
function b(e) {
for (var t, n, o, i = e.length, r = C.relative[e[0].type], a = r || C.relative[" "], s = r ? 1 :0, l = _(function(e) {
return e === t;
}, a, !0), c = _(function(e) {
return at.call(t, e) > -1;
}, a, !0), u = [ function(e, n, o) {
return !r && (o || n !== Y) || ((t = n).nodeType ? l(e, n, o) :c(e, n, o));
} ]; i > s; s++) if (n = C.relative[e[s].type]) u = [ _(y(u), n) ]; else {
if (n = C.filter[e[s].type].apply(null, e[s].matches), n[j]) {
for (o = ++s; i > o && !C.relative[e[o].type]; o++) ;
return w(s > 1 && y(u), s > 1 && f(e.slice(0, s - 1).concat({
value:" " === e[s - 2].type ? "*" :""
...
var d, p, h, m = [], g = 0, f = "0", _ = r && [], y = null != u, w = Y, b = r || a && C.find.TAG("*", u && s.parentNode || s), x = W += null == w ? 1 :Math.random() || .1;
for (y && (Y = s !== O && s, D = o); null != (d = b[f]); f++) {
if (a && d) {
...
i && ((d = !h && d) && g--, r && _.push(d));
}
if (g += f, i && f !== g) {
for (p = 0; h = t[p++]; ) h(_, m, s, l);
if (r) {
if (g > 0) for (;f--; ) _[f] || m[f] || (m[f] = nt.call(c));
m = v(m);
}
it.apply(c, m), y && !r && m.length > 0 && g + t.length > 1 && n.uniqueSort(c);
}
return y && (W = x, Y = w), _;
};
return i ? r(s) :s;
...
var i, r, a, s, l, c = g(e);
if (!o && 1 === c.length) {
if (r = c[0] = c[0].slice(0), r.length > 2 && "ID" === (a = r[0]).type && L.getById && 9 === t.nodeType && B && C.relative[r[1].type]) {
if (t = (C.find.ID(a.matches[0].replace(Lt, Dt), t) || [])[0], !t) return n;
e = e.slice(r.shift().value.length);
}
for (i = bt.needsContext.test(e) ? 0 :r.length; i-- && (a = r[i], !C.relative[s = a.type]); ) if ((l = C.find[s]) && (o = l(a.matches[0].replace(Lt, Dt), _t.test(r[0].type) && t.parentNode || t))) {
if (r.splice(i, 1), e = o.length && f(r), !e) return it.apply(n, o), n;
break;
}
}
return I(e, c)(o, t, !B, n, _t.test(e)), n;
}
function T() {}
var M, L, D, C, E, $, I, Y, A, q, O, N, B, P, H, F, R, j = "sizzle" + -new Date(), z = e.document, W = 0, U = 0, V = i(), G = i(), X = i(), J = !1, K = function() {
return 0;
}, Q = typeof t, Z = 1 << 31, et = {}.hasOwnProperty, tt = [], nt = tt.pop, ot = tt.push, it = tt.push, rt = tt.slice, at = tt.indexOf || function(e) {
for (var t = 0, n = this.length; n > t; t++) if (this[t] === e) return t;
return -1;
}, st = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", lt = "[\\x20\\t\\r\\n\\f]", ct = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", dt = ct.replace("w", "w#"), pt = "\\[" + lt + "*(" + ct + ")" + lt + "*(?:([*^$|!~]?=)" + lt + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + dt + ")|)|)" + lt + "*\\]", ht = ":(" + ct + ")(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + pt.replace(3, 8) + ")*)|.*)\\)|)", mt = new RegExp("^" + lt + "+|((?:^|[^\\\\])(?:\\\\.)*)" + lt + "+$", "g"), gt = new RegExp("^" + lt + "*," + lt + "*"), ft = new RegExp("^" + lt + "*([>+~]|" + lt + ")" + lt + "*"), _t = new RegExp(lt + "*[+~]"), yt = new RegExp("=" + lt + "*([^\\]'\"]*)" + lt + "*\\]", "g"), vt = new RegExp(ht), wt = new RegExp("^" + dt + "$"), bt = {
ID:new RegExp("^#(" + ct + ")"),
CLASS:new RegExp("^\\.(" + ct + ")"),
...
}, xt = /^[^{]+\{\s*\[native \w/, kt = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, St = /^(?:input|select|textarea|button)$/i, Tt = /^h\d$/i, Mt = /'|\\/g, Lt = new RegExp("\\\\([\\da-f]{1,6}" + lt + "?|(" + lt + ")|.)", "ig"), Dt = function(e, t, n) {
var o = "0x" + t - 65536;
...
}, L = n.support = {}, q = n.setDocument = function(e) {
var t = e ? e.ownerDocument || e :z;
return t !== O && 9 === t.nodeType && t.documentElement ? (O = t, N = t.documentElement, 
B = !$(t), L.attributes = a(function(e) {
...
return N.appendChild(e).id = j, !t.getElementsByName || !t.getElementsByName(j).length;
}), L.getById ? (C.find.ID = function(e, t) {
if (typeof t.getElementById !== Q && B) {
...
}), C.find.TAG = L.getElementsByTagName ? function(e, t) {
...
return r;
}, C.find.CLASS = L.getElementsByClassName && function(e, t) {
return typeof t.getElementsByClassName !== Q && B ? t.getElementsByClassName(e) :void 0;
}, H = [], P = [], (L.qsa = o(t.querySelectorAll)) && (a(function(e) {
e.innerHTML = "<select><option selected=''></option></select>", e.querySelectorAll("[selected]").length || P.push("\\[" + lt + "*(?:value|" + st + ")"), 
e.querySelectorAll(":checked").length || P.push(":checked");
}), a(function(e) {
var n = t.createElement("input");
n.setAttribute("type", "hidden"), e.appendChild(n).setAttribute("t", ""), e.querySelectorAll("[t^='']").length && P.push("[*^$]=" + lt + "*(?:''|\"\")"), 
e.querySelectorAll(":enabled").length || P.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), 
P.push(",.*:");
})), (L.matchesSelector = o(F = N.webkitMatchesSelector || N.mozMatchesSelector || N.oMatchesSelector || N.msMatchesSelector)) && a(function(e) {
L.disconnectedMatch = F.call(e, "div"), F.call(e, "[s!='']:x"), H.push("!=", ht);
}), P = P.length && new RegExp(P.join("|")), H = H.length && new RegExp(H.join("|")), 
R = o(N.contains) || N.compareDocumentPosition ? function(e, t) {
...
}), K = N.compareDocumentPosition ? function(e, n) {
if (e === n) return J = !0, 0;
var o = n.compareDocumentPosition && e.compareDocumentPosition && e.compareDocumentPosition(n);
return o ? 1 & o || !L.sortDetached && n.compareDocumentPosition(e) === o ? e === t || R(z, e) ? -1 :n === t || R(z, n) ? 1 :A ? at.call(A, e) - at.call(A, n) :0 :4 & o ? -1 :1 :e.compareDocumentPosition ? -1 :1;
} :function(e, n) {
var o, i = 0, r = e.parentNode, a = n.parentNode, s = [ e ], l = [ n ];
if (e === n) return J = !0, 0;
if (!r || !a) return e === t ? -1 :n === t ? 1 :r ? -1 :a ? 1 :A ? at.call(A, e) - at.call(A, n) :0;
if (r === a) return d(e, n);
...
if ((e.ownerDocument || e) !== O && q(e), t = t.replace(yt, "='$1']"), !(!L.matchesSelector || !B || H && H.test(t) || P && P.test(t))) try {
var o = F.call(e, t);
...
var o = C.attrHandle[n.toLowerCase()], i = o && et.call(C.attrHandle, n.toLowerCase()) ? o(e, n, !B) :t;
return i === t ? L.attributes || !B ? e.getAttribute(n) :(i = e.getAttributeNode(n)) && i.specified ? i.value :null :i;
}, n.error = function(e) {
throw new Error("Syntax error, unrecognized expression: " + e);
}, n.uniqueSort = function(e) {
var t, n = [], o = 0, i = 0;
if (J = !L.detectDuplicates, A = !L.sortStable && e.slice(0), e.sort(K), J) {
...
preFilter:{
ATTR:function(e) {
return e[1] = e[1].replace(Lt, Dt), e[3] = (e[4] || e[5] || "").replace(Lt, Dt), 
...
filter:{
TAG:function(e) {
var t = e.replace(Lt, Dt).toLowerCase();
return "*" === e ? function() {
return !0;
} :function(e) {
...
var c, u, d, p, h, m, g = r !== a ? "nextSibling" :"previousSibling", f = t.parentNode, _ = s && t.nodeName.toLowerCase(), y = !l && !s;
if (f) {
if (r) {
for (;g; ) {
for (d = t; d = d[g]; ) if (s ? d.nodeName.toLowerCase() === _ :1 === d.nodeType) return !1;
m = g = "only" === e && !m && "nextSibling";
}
return !0;
}
if (m = [ a ? f.firstChild :f.lastChild ], a && y) {
for (u = f[j] || (f[j] = {}), c = u[e] || [], h = c[0] === W && c[1], p = c[0] === W && c[2], 
d = h && f.childNodes[h]; d = ++h && d && d[g] || (p = h = 0) || m.pop(); ) if (1 === d.nodeType && ++p && d === t) {
u[e] = [ W, h, p ];
break;
}
} else if (y && (c = (t[j] || (t[j] = {}))[e]) && c[0] === W) p = c[1]; else for (;(d = ++h && d && d[g] || (p = h = 0) || m.pop()) && ((s ? d.nodeName.toLowerCase() !== _ :1 !== d.nodeType) || !++p || (y && ((d[j] || (d[j] = {}))[e] = [ W, p ]), 
d !== t)); ) ;
...
PSEUDO:function(e, t) {
var o, i = C.pseudos[e] || C.setFilters[e.toLowerCase()] || n.error("unsupported pseudo: " + e);
return i[j] ? i(t) :i.length > 1 ? (o = [ e, e, "", t ], C.setFilters.hasOwnProperty(e.toLowerCase()) ? r(function(e, n) {
...
lang:r(function(e) {
return wt.test(e || "") || n.error("unsupported lang: " + e), e = e.replace(Lt, Dt).toLowerCase(), 
function(t) {
var n;
...
return r;
}, C.pseudos.nth = C.pseudos.eq, T.prototype = C.filters = C.pseudos, C.setFilters = new T(), 
L.sortStable = j.split("").sort(K).join("") === j, q(), [ 0, 0 ].sort(K), L.detectDuplicates = J, 
...
var n, o, i, r, a, s, l, c, u, d = J.createElement("div");
...
r = J.createElement("select"), s = r.appendChild(J.createElement("option")), i = d.getElementsByTagName("input")[0], 
...
var n, o, i, r = "padding:0;margin:0;border:0;display:block;box-sizing:content-box;-moz-box-sizing:content-box;-webkit-box-sizing:content-box;", a = J.getElementsByTagName("body")[0];
...
width:"4px"
}).width, o = d.appendChild(J.createElement("div")), o.style.cssText = d.style.cssText = r, 
...
var Dt, Ct, Et = /[\t\r\n\f]/g, $t = /\r/g, It = /^(?:input|select|textarea|button|object)$/i, Yt = /^(?:a|area)$/i, At = /^(?:checked|selected)$/i, qt = ut.support.getSetAttribute, Ot = ut.support.input;
ut.fn.extend({
attr:function(e, t) {
...
o && "get" in o && (n = o.get(r, "value")) !== t ? n :(n = r.value, "string" == typeof n ? n.replace($t, "") :null == n ? "" :n);
}
}
}), ut.extend({
valHooks:{
...
i = ut.attrHooks[n] || (ut.expr.match.bool.test(n) ? Ct :Dt)), o === t ? i && "get" in i && null !== (r = i.get(e, n)) ? r :(r = ut.find.attr(e, n), 
null == r ? t :r) :null !== o ? i && "set" in i && (r = i.set(e, o, n)) !== t ? r :(e.setAttribute(n, o + ""), 
o) :void ut.removeAttr(e, n));
},
removeAttr:function(e, t) {
var n, o, i = 0, r = t && t.match(pt);
if (r && 1 === e.nodeType) for (;n = r[i++]; ) o = ut.propFix[n] || n, ut.expr.match.bool.test(n) ? Ot && qt || !At.test(n) ? e[o] = !1 :e[ut.camelCase("default-" + n)] = e[o] = !1 :ut.attr(e, n, ""), 
e.removeAttribute(qt ? n :o);
},
attrHooks:{
type:{
set:function(e, t) {
...
return t ? parseInt(t, 10) :It.test(e.nodeName) || Yt.test(e.nodeName) && e.href ? 0 :-1;
}
}
}
}), Ct = {
set:function(e, t, n) {
return t === !1 ? ut.removeAttr(e, n) :Ot && qt || !At.test(n) ? e.setAttribute(!qt && ut.propFix[n] || n, n) :e[ut.camelCase("default-" + n)] = e[n] = !0, 
n;
}
}, ut.each(ut.expr.match.bool.source.match(/\w+/g), function(e, n) {
var o = ut.expr.attrHandle[n] || ut.find.attr;
ut.expr.attrHandle[n] = Ot && qt || !At.test(n) ? function(e, n, i) {
...
set:function(e, t, n) {
return ut.nodeName(e, "input") ? void (e.defaultValue = t) :Dt && Dt.set(e, t, n);
}
}), qt || (Dt = {
set:function(e, n, o) {
...
var Nt = /^(?:input|select|textarea)$/i, Bt = /^key/, Pt = /^(?:mouse|contextmenu)|click/, Ht = /^(?:focusinfocus|focusoutblur)$/, Ft = /^([^.]*)(?:\.(.+)|)$/;
ut.event = {
global:{},
add:function(e, n, o, i, r) {
var a, s, l, c, u, d, p, h, m, g, f, _ = ut._data(e);
if (_) {
for (o.handler && (c = o, o = c.handler, r = c.selector), o.guid || (o.guid = ut.guid++), 
(s = _.events) || (s = _.events = {}), (d = _.handle) || (d = _.handle = function(e) {
...
var a, s, l, c, u, d, p, h = [ i || J ], m = lt.call(n, "type") ? n.type :n, g = lt.call(n, "namespace") ? n.namespace.split(".") :[];
if (l = d = i = i || J, 3 !== i.nodeType && 8 !== i.nodeType && !Ht.test(m + ut.event.triggered) && (m.indexOf(".") >= 0 && (g = m.split("."), 
...
for (c = u.delegateType || m, Ht.test(c + m) || (l = l.parentNode); l; l = l.parentNode) h.push(l), 
d = l;
d === (i.ownerDocument || J) && h.push(d.defaultView || d.parentWindow || e);
}
...
for (a || (this.fixHooks[i] = a = Pt.test(i) ? this.mouseHooks :Bt.test(i) ? this.keyHooks :{}), 
o = a.props ? this.props.concat(a.props) :this.props, e = new ut.Event(r), t = o.length; t--; ) n = o[t], 
e[n] = r[n];
return e.target || (e.target = r.srcElement || J), 3 === e.target.nodeType && (e.target = e.target.parentNode), 
...
setup:function() {
return Nt.test(this.nodeName) ? (("checkbox" === this.type || "radio" === this.type) && (ut.event.add(this, "propertychange._change", function(e) {
...
var t = e.target;
Nt.test(t.nodeName) && !ut._data(t, "changeBubbles") && (ut.event.add(t, "change._change", function(e) {
...
var Rt = /^.[^:#\[\.,]*$/, jt = /^(?:parents|prev(?:Until|All))/, zt = ut.expr.match.needsContext, Wt = {
children:!0,
contents:!0,
next:!0,
prev:!0
...
this.length > 1 && (Wt[e] || (i = ut.unique(i)), jt.test(e) && (i = i.reverse())), 
this.pushStack(i);
};
}), ut.extend({
...
var Ut = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video", Vt = / jQuery\d+="(?:null|\d+)"/g, Gt = new RegExp("<(?:" + Ut + ")[\\s/>]", "i"), Xt = /^\s+/, Jt = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Kt = /<([\w:]+)/, Qt = /<tbody/i, Zt = /<|&#?\w+;/, en = /<(?:script|style|link)/i, tn = /^(?:checkbox|radio)$/i, nn = /checked\s*(?:[^=]|=\s*.checked.)/i, on = /^$|\/(?:java|ecma)script/i, rn = /^true\/(.*)/, an = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, sn = {
...
n.parentNode && (t && ut.contains(n.ownerDocument, n) && _(w(n, "script")), n.parentNode.removeChild(n));
return this;
},
empty:function() {
...
if (!("string" != typeof e || en.test(e) || !ut.support.htmlSerialize && Gt.test(e) || !ut.support.leadingWhitespace && Xt.test(e) || sn[(Kt.exec(e) || [ "", "" ])[1].toLowerCase()])) {
e = e.replace(Jt, "<$1></$2>");
try {
...
if (t) if (n) for (s = s || w(e), o = o || w(r), a = 0; null != (i = s[a]); a++) y(i, o[a]); else y(e, r);
return o = w(r, "script"), o.length > 0 && _(o, !l && w(e, "script")), o = s = i = null, 
r;
},
...
u = sn[l] || sn._default, s.innerHTML = u[1] + r.replace(Jt, "<$1></$2>") + u[2], 
i = u[0]; i--; ) s = s.lastChild;
if (!ut.support.leadingWhitespace && Xt.test(r) && m.push(t.createTextNode(Xt.exec(r)[0])), 
...
s = w(p.appendChild(r), "script"), a && _(s), n)) for (i = 0; r = s[i++]; ) on.test(r.type || "") && n.push(r);
return s = null, p;
},
...
var un, dn, pn, hn = /alpha\([^)]*\)/i, mn = /opacity\s*=\s*([^)]*)/, gn = /^(top|right|bottom|left)$/, fn = /^(none|table(?!-c[ea]).+)/, _n = /^margin/, yn = new RegExp("^(" + dt + ")(.*)$", "i"), vn = new RegExp("^(" + dt + ")(?!px)[a-z%]+$", "i"), wn = new RegExp("^([+-])=(" + dt + ")", "i"), bn = {
BODY:"block"
}, xn = {
position:"absolute",
visibility:"hidden",
...
vn.test(l) && _n.test(n) && (i = c.width, r = c.minWidth, a = c.maxWidth, c.minWidth = c.maxWidth = c.width = l, 
...
}, _n.test(e) || (ut.cssHooks[e + t].set = T);
});
...
var e = this.type;
return this.name && !ut(this).is(":disabled") && En.test(this.nodeName) && !Cn.test(e) && (this.checked || !tn.test(e));
}).map(function(e, t) {
var n = ut(this).val();
...
var $n, In, Yn = ut.now(), An = /\?/, qn = /#.*$/, On = /([?&])_=[^&]*/, Nn = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, Bn = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Pn = /^(?:GET|HEAD)$/, Hn = /^\/\//, Fn = /^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/, Rn = ut.fn.load, jn = {}, zn = {}, Wn = "*/".concat("*");
try {
In = X.href;
} catch (Un) {
In = J.createElement("a"), In.href = "", In = In.href;
}
...
return t ? Y(Y(e, ut.ajaxSettings), t) :Y(ut.ajaxSettings, e);
},
ajaxPrefilter:$(jn),
ajaxTransport:$(zn),
ajax:function(e, n) {
...
r = e >= 200 && 300 > e || 304 === e, o && (v = A(p, x, o)), v = q(p, v, x, r), 
...
d = v.data, y = v.error, r = !y)) :(y = k, (e || !k) && (k = "error", 0 > e && (e = 0))), 
x.status = e, x.statusText = (n || k) + "", r ? g.resolveWith(h, [ d, k, x ]) :g.rejectWith(h, [ x, k, y ]), 
x.statusCode(_), _ = t, c && m.trigger(r ? "ajaxSuccess" :"ajaxError", [ x, p, r ? d :y ]), 
f.fireWith(h, [ x, k ]), c && (m.trigger("ajaxComplete", [ x, p ]), --ut.active || ut.event.trigger("ajaxStop")));
}
"object" == typeof e && (n = e, e = t), n = n || {};
var i, r, a, s, l, c, u, d, p = ut.ajaxSetup({}, n), h = p.context || p, m = p.context && (h.nodeType || h.jquery) ? ut(h) :ut.event, g = ut.Deferred(), f = ut.Callbacks("once memory"), _ = p.statusCode || {}, y = {}, v = {}, w = 0, b = "canceled", x = {
readyState:0,
getResponseHeader:function(e) {
var t;
if (2 === w) {
if (!d) for (d = {}; t = Nn.exec(s); ) d[t[1].toLowerCase()] = t[2];
t = d[e.toLowerCase()];
}
...
var t;
if (e) if (2 > w) for (t in e) _[t] = [ _[t], e[t] ]; else x.always(e[x.status]);
return this;
},
abort:function(e) {
var t = e || b;
...
if (g.promise(x).complete = f.add, x.success = x.done, x.error = x.fail, p.url = ((e || p.url || In) + "").replace(qn, "").replace(Hn, $n[1] + "//"), 
p.type = n.method || n.type || p.method || p.type, p.dataTypes = ut.trim(p.dataType || "*").toLowerCase().match(pt) || [ "" ], 
null == p.crossDomain && (i = Fn.exec(p.url.toLowerCase()), p.crossDomain = !(!i || i[1] === $n[1] && i[2] === $n[2] && (i[3] || ("http:" === i[1] ? "80" :"443")) === ($n[3] || ("http:" === $n[1] ? "80" :"443")))), 
...
p.hasContent = !Pn.test(p.type), a = p.url, p.hasContent || (p.data && (a = p.url += (An.test(a) ? "&" :"?") + p.data, 
delete p.data), p.cache === !1 && (p.url = On.test(a) ? a.replace(On, "$1_=" + Yn++) :a + (An.test(a) ? "&" :"?") + "_=" + Yn++)), 
...
if (e.crossDomain) {
var n, o = J.head || ut("head")[0] || J.documentElement;
return {
send:function(t, i) {
...
l ? n[l] = n[l].replace(Gn, "$1" + r) :n.jsonp !== !1 && (n.url += (An.test(n.url) ? "&" :"?") + n.jsonp + "=" + r), 
...
var Xn, Jn, Kn = 0, Qn = e.ActiveXObject && function() {
var e;
for (e in Xn) Xn[e](t, !0);
};
ut.ajaxSettings.xhr = e.ActiveXObject ? function() {
return !this.isLocal && O() || N();
} :O, Jn = ut.ajaxSettings.xhr(), ut.support.cors = !!Jn && "withCredentials" in Jn, 
...
Qn && delete Xn[a]), i) 4 !== l.readyState && l.abort(); else {
...
d && r(s, u, d, c);
}, n.async ? 4 === l.readyState ? setTimeout(o) :(a = ++Kn, Qn && (Xn || (Xn = {}, 
ut(e).unload(Qn)), Xn[a] = o), l.onreadystatechange = o) :o();
},
abort:function() {
o && o(t, !0);
}
...
var Zn, eo, to = /^(?:toggle|show|hide)$/, no = new RegExp("^(?:([+-])=|)(" + dt + ")([a-z%]*)$", "i"), oo = /queueHooks$/, io = [ R ], ro = {
"*":[ function(e, t) {
